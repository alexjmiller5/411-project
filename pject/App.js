...
export default function App() {
    ...
    const handleButtonClick = () => {
        if (location) {
            ...
            const url = `https://maps.googleapis.com/maps/api/directions/json?origin=${location.latitude},${location.longitude}&destination=Boston%20University&mode=driving&key=REDACTED-GCP-KEY`;
